    ...
    return (
        <div className="min-h-screen bg-white px-4 py-6">
            <header className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-xl font-semibold text-slate-800">Ajouter un mot · {categoryName}</h1>
            </header>
            ...
            >
                <div>
                    <label className="text-sm text-slate-600 block mb-1" htmlFor="word-term">
                        Mot en coréen *
                    </label>
                    <input
                        id="word-term"
                ...
                <div>
                    <label className="text-sm text-slate-600 block mb-1" htmlFor="word-pronunciation">
                        Prononciation
                    </label>
                    <input
                ...
                <div>
                    <label className="text-sm text-slate-600 block mb-1" htmlFor="word-translation">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="px-3 py-1.5 bg-white border border-amber-300 rounded-md text-sm"
                            >
                                Annuler
                            </button>
                        </div>
